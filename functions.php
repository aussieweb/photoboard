 ...
 */
	...
	function keel_load_theme_files() {
		wp_enqueue_style( 'keel-theme-styles', get_template_directory_uri() . '/dist/css/main.min.11152014.css', null, null, 'all' );
		wp_enqueue_script( 'keel-theme-scripts', get_template_directory_uri() . '/dist/js/main.min.11152014.js', null, null, true );
	}
